...
#include "mxm_app_platform_cfg.h"

#include "mxm_app_perfids.h"
...
typedef struct
{
    ...
    */
    MXM_APP_HkTlm_t HkTlm;

    /*
    ** Compute result telemetry packet...
    */
    MXM_APP_ResultTlm_t ResultTlm;
...
*/
extern MXM_APP_Data_t MXM_APP_Data;

/****************************************************************************/
/*
** Local function prototypes.
**
** Note: Except for the entry point (MXM_APP_Main), these
